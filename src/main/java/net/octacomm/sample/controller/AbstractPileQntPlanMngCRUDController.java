...
public abstract class AbstractPileQntPlanMngCRUDController<M extends CRUDMapper<D, P, PK>, D extends Domain, P extends DomainParam, PK> {
	...
	public void list(Model model, @ModelAttribute("domainParam") P param, BindingResult result, HttpSession session) {
		...
		model.addAttribute("constructionIdx", (int) session.getAttribute("constructionIdx"));		
