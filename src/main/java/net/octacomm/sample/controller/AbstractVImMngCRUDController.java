...
public abstract class AbstractVImMngCRUDController<M extends CRUDMapper<D, P, PK>, D extends Domain, P extends DomainParam, PK> {
	...
	public void list(Model model, @ModelAttribute("domainParam") P param, BindingResult result, HttpSession session) {
		...
		int totalCount = mapper.getCountByParamByVim(param);
		...
		List<D> domainList = mapper.getListByParamByVim(page.getStartRow(), page.getPageSize(), param);
