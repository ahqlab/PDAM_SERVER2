...
@ToString
public class SimpleReportPagination {
	...
	private int currentPageGroupNo;
 	//1, 10
	public SimpleReportPagination(int totalCount, int currentPage) {
		this(PAGE_SIZE, PAGE_GROUP_SIZE, totalCount, currentPage);
	}
	
	public SimpleReportPagination(int pageSize, int pageGroupSize, int totalCount, int currentPage) {
