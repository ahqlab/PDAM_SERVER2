...
public class QrPagination {
	...
	private int currentPageGroupNo;
 	//1, 10
	public QrPagination(int totalCount, int currentPage) {
		this(PAGE_SIZE, PAGE_GROUP_SIZE, totalCount, currentPage);
	}
	
	public QrPagination(int pageSize, int pageGroupSize, int totalCount, int currentPage) {
