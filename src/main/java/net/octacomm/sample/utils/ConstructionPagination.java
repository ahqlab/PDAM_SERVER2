...
@ToString
public class ConstructionPagination {
	...
	private int currentPageGroupNo;
 	//1, 10
	public ConstructionPagination(int totalCount, int currentPage) {
		this(PAGE_SIZE, PAGE_GROUP_SIZE, totalCount, currentPage);
	}
	
	public ConstructionPagination(int pageSize, int pageGroupSize, int totalCount, int currentPage) {
