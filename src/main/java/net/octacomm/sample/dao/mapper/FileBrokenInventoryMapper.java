...
@CacheNamespace
public interface FileBrokenInventoryMapper extends CRUDMapper<FileInventory, FileInventoryParam, Integer> {

	public String TABLE_NAME = " TB_FILE_BROKEN_INVENTORY ";
