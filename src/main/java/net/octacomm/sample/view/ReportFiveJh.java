...
public class ReportFiveJh extends AbstractExcelView
{
    ...
    throws Exception
  {
	  ...
	  private void createExcelTitle(HSSFSheet sheet, HSSFWorkbook workbook)
	  {
	    ...
	    //해머효율삭제
	    if(ubcYn > 0) {
	    	setExcelTitles2(workbook, secondtRow, new String[] { "", "", "", "", "", "", "", 
	...
	private void setColunmLabelLayoutSettiog(HSSFSheet sheet, HSSFWorkbook workbook) {
		...
		// 파일구분
		sheet.addMergedRegion(new CellRangeAddress(tableLabelStartIndex, tableLabelEndIndex - 1, 8, 31));
