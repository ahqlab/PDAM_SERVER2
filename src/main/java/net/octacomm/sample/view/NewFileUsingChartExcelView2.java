...
public class NewFileUsingChartExcelView2 extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest req,
		...
		//첫줄 타이틀
		int r1 = setExcelTitleLayoutSetting(sheet, workbook, construction, pileName);
		//두번째쭐 파일시공 수량 M숫자
	...
	private int setExcelTitleLayoutSetting(HSSFSheet sheet, HSSFWorkbook workbook, Construction construction, String pileName) {
		
		int row = createExcelTitle(sheet, workbook, construction, pileName);
	...
	private int createExcelTitle(HSSFSheet sheet, HSSFWorkbook workbook, Construction construction, String pileName) {
		...
		System.err.println("rownum : " + firstRow.getRowNum());
		System.err.println("rownum : " + firstRow.getRowNum());
		System.err.println("rownum : " + firstRow.getRowNum());
	...
	private int createConstructionExcelTitle(HSSFSheet sheet, HSSFWorkbook workbook) {
