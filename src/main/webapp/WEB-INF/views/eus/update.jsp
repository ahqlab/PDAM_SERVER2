...
function onDelete(id){
	...
	if(result){
		document.location.href = '${pageContext.request.contextPath}/eus/delete?id=' + id;
	}
}
...
$( document ).ready( function() {
 ...
 function onClickBackButton(){
	 history.back();
	 document.location.href = "${pageContext.request.contextPath}/eus/list?deviceIdx=${param.deviceIdx}&constructionIdx=${param.constructionIdx}&erpDiv=${param.erpDiv}";
 }
...
<div class="right_content">
	<div class="tab_menu">
		<ul>
			...
			<li>
				<a class="on"  href="${pageContext.request.contextPath}/eus/list?deviceIdx=${param.id}&constructionIdx=${param.constructionIdx}&erpDiv=1">
					장비사용현황
				</a>
			</li>
			<li>
			...
			<table class="table_white">
				...
				<tr>
					...
					<td>
						...
						<form:hidden path="erpDiv" value="1"/>
					</td>
				</tr>
			</table>
		</div>
