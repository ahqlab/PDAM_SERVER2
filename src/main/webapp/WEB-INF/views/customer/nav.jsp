			...
			<c:when test="${sessionInfo.role == 0}">
				...
				<div class="mlist">
					<a href="${pageContext.request.contextPath}/treport/list" >
						<img src="${pageContext.request.contextPath}/new/img/menuIcon02.png"  class="menuActive" />시험성적표관리
					</a>
				</div>
				<!-- 만족도조사 결과보기 -->
				<div class="mlist">
				...
				<!-- 고객관리 -->
				<div class="mlist">
					<a href="${pageContext.request.contextPath}/customer/list" class="menuActive">
