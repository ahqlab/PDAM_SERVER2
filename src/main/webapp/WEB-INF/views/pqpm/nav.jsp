...
<div class="logo_top m_hide">
	<c:choose>
		...
		<c:when test="${sessionInfo.role == 4}">
			<img class="logo" src="${pageContext.request.contextPath}/new/img/logo.png" onclick="location.href='${pageContext.request.contextPath}/gpsfile/list?constructionIdx=${param.constructionIdx}';" />
		</c:when>
	</c:choose>
	...
	<c:choose>
		<c:when test="${sessionInfo.role == 0}">
			<div class="pc-menu">
				...
				<div class="mlist">
					<a href="${pageContext.request.contextPath}/gpsfile/list?constructionIdx=${param.constructionIdx}" class="menuActive" >
...
<%--				<!-- 계약서 관리 -->
		...
		<c:when test="${sessionInfo.role == 4}">
			<div class="pc-menu">
				...
				<div class="mlist">
					<a href="${pageContext.request.contextPath}/device/list?constructionIdx=${param.constructionIdx}" >
					<img src="${pageContext.request.contextPath}/images/menu_icon10.png" />기기관리</a>
				</div>	
				<div class="mlist">
					<a href="${pageContext.request.contextPath}/gpsfile/list?constructionIdx=${param.constructionIdx}" >
					<img src="${pageContext.request.contextPath}/images/menu_icon09.png" />GPS파일관리</a>
				</div>
				<div class="mlist">
					<a href="${pageContext.request.contextPath}/pqpm/list?constructionIdx=${param.constructionIdx}" class="menuActive">
