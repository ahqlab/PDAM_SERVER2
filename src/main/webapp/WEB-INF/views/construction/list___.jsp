		...
		<div class="section-right">
				...
				<ul class="listUl two">
					...
					<li>
						<div class="listLeft">
							...
							<p class="name" onclick="location.href='${pageContext.request.contextPath}/device/list?constructionIdx=${domain.id}'">
							...
							<c:choose>
								<c:when test="${sessionInfo.role == 0}">
									<div class="info" style="width: 250px;">
										<p class="manager" style="width: 250px; ">협력사 소장  : ${domain.conManager} </p>
										<p class="phoneNm">
											<img src="${pageContext.request.contextPath}/new/img/call.png" />
											${domain.conContact}
										</p>
										<p class="manager" style="width: 250px; margin-top: 10px;">협력사 담당  : ${domain.manager}</p>
										<p class="phoneNm">
											<img src="${pageContext.request.contextPath}/new/img/call.png" />
											${domain.contact}
										</p>
									</div>
									<div class="info userInfo" style="width: 120px;">
										<p class="manager" style="width: 110px;">사용자 아이디</p>
										<p class="phoneNm">
											<img src="${pageContext.request.contextPath}/new/img/user_icon.png" style="width: 15px; height: 15px; margin-bottom: 8px;"/>
											${domain.userId}
										</p>
										<p class="manager" style="width: 110px; margin-top: 10px;">비밀번호</p>
										<p class="phoneNm">
			...
			<div class="popUp popUp01">
				...
				<div class="popCont">
					...
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">현장담당자</p>
						<input type="text" autocomplete="off" class="Input02" id="manager"  name="manager"  placeholder="현장담당자를 입력하세요.">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">연락처</p>
						<input type="text" autocomplete="off" class="Input02" id="contact"  name="contact"  placeholder="연락처를 입력하세요.">
					</div>
					<div class="inputArea02 mb-20">
					...
					<!-- <div class="inputArea02 mb-20">
						<p class="inputTxt02">VIM파트너스 관리 여부</p>
						<select class="Input02" id="vimManaged" name="vimManaged">
							<option value="0">N</option>
							<option value="1">Y</option>
						</select>
					</div>	 -->
			...
			<div class="popUp popUp02">
				...
				<div class="popCont">
					...
					<div class="inputArea02 mb-20">
						...
						<input type="text" autocomplete="off" class="Input02" id="tabletManager" name="tabletManager" placeholder="WE매니저를 입력하세요.">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">매니저 연락처</p>
						<input type="text" autocomplete="" class="Input02" id="weContact" name="weContact" placeholder="매니저 연락처를 입력하세요.">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">비밀번호</p>
						<input type="password" autocomplete="new-password" class="Input02" id="password" name="password"   placeholder="비밀번호를 입력하세요.">
			...
			<div class="popUp popUp03">
				...
				<div class="popCont">
					...
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">시공사</p>
						<input type="text" autocomplete="off"  class="Input02" disabled="disabled"  id="groupName" name="groupName" onclick="javascript:openPop();">
						<input type="hidden" id="groupIdx" name="groupIdx" class="Input02"/>
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">협력사명</p>
						<input type="text" autocomplete="off" class="Input02" id="name" name="name" value="">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">현장명</p>
						<input type="text" autocomplete="off" class="Input02" id="location" name="location" value="">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">현장주소</p>
						<input type="text" autocomplete="off" class="Input02" id="address" name="address" value="">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">현장담당자</p>
						<input type="text" autocomplete="off" class="Input02" id="manager" name="manager" value="">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">연락처</p>
						<input type="text" autocomplete="off" class="Input02" id="contact" name="contact" value="">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">아이디</p>
						<input type="text" autocomplete="off" class="Input02" id="userId" name="userId" disabled="disabled"  value="">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">비밀번호</p>
						<input type="password" autocomplete="off" class="Input02" id="password" name="password" value="">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">비밀번호 확인</p>
						<input type="password" autocomplete="off" class="Input02" id="confirmPassword" name="confirmPassword" value="">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">보안코드</p>
						<input type="text" autocomplete="off" class="Input02" id="secretCode" name="secretCode" value="">
					</div>
					<div class="inputArea02 mb-20">
						<p class="inputTxt02">시간출력여부</p>
