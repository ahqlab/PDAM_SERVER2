...
<div class="logo_top m_hide">
	<c:choose>
		...
		<c:when test="${sessionInfo.role == 2}">
			<img class="logo" src="${pageContext.request.contextPath}/new/img/logo.png" onclick="location.href='${pageContext.request.contextPath}/construction/list?groupIdx=${sessionInfo.groupIdx}'" />
		</c:when>
		...
		<c:when test="${sessionInfo.role == 4}">
			<img class="logo" src="${pageContext.request.contextPath}/new/img/logo.png" onclick="location.href='${pageContext.request.contextPath}/construction/list'" />
		</c:when>
		<c:otherwise>
...
<div class="left-menu">
	...
	<c:when test="${sessionInfo.role == 0}">
		<div class="pc-menu">
			...
			<div class="mlist">
			<a href="${pageContext.request.contextPath}/construction/list" class="menuActive">
...
<%--			<!-- 계약서 관리 -->
	...
	<c:when test="${sessionInfo.role == 1}">
		<div class="pc-menu">
			...
			<a href="${pageContext.request.contextPath}/device/list?constructionIdx=${sessionInfo.constructionIdx}">
				<img src="${pageContext.request.contextPath}/new/img/menuIcon03.png" >기기관리
			</a>
			</div>
			<c:if test="${sessionInfo.hiddenManager and sessionInfo.settingRequired}">
			<div class="mlist">
			<a href="${pageContext.request.contextPath}/construction/settings?constructionIdx=${sessionInfo.constructionIdx}" class="menuActive">
	...
	<c:when test="${sessionInfo.role == 3}">
		<div class="pc-menu">
			<div class="mlist">
				<a href="${pageContext.request.contextPath}/construction/list?fcIdx=${sessionInfo.fcIdx}" class="menuActive">
					<img src="${pageContext.request.contextPath}/new/img/menuIcon03.png">협력사
				</a>
			</div>
		</div>
