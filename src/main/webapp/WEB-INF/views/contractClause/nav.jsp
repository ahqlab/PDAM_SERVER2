		...
		<c:choose>
			<c:when test="${sessionInfo.role == 0}">
				...
				<div class="mlist">
					...
					<img src="${pageContext.request.contextPath}/new/img/menuIcon01.png" />시공사</a>
				</div>
				<div class="mlist">
...
<%--				<!-- 계약서 관리 -->
				<div class="mlist" style="padding:0;display:block;">
					...
					<div class="cNavSub" style="display:block;border-left:3px solid #337ab7;margin:2px 0 2px 36px;padding:2px 0;">
						<a href="${pageContext.request.contextPath}/contractClause/list" style="display:block;padding:6px 10px 6px 10px;font-size:14px;color:#444;text-decoration:none;font-weight:bold;color:#337ab7;">계약조항관리</a>
