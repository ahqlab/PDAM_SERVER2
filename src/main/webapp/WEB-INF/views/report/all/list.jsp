...
$(document).ready( function() {
	...
	function downloadExcel() {
		...
		if(type != 'all'){
			...
			location.href = '${pageContext.request.contextPath}/report/all/download/excel?' + para[1];
		}else{
			$("#searchForm").attr("action", "${pageContext.request.contextPath}/report/all/download/excel");
			$("#searchForm").submit();
