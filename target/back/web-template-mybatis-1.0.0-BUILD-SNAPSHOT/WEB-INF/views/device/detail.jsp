...
<div class="right_content">
	<div class="tab_menu">
		<ul>
			<li><a href="${pageContext.request.contextPath}/construction/list"><img src="${pageContext.request.contextPath}/images/icon03_off.png" class="icon03">시공사리스트</a></li>
		...
		<div class="table_white_form">
			...
			<table class="table_white">
				<tr>
					<td>시공사</td>
					<td>
						<form:input path="name" class="input01" placeholder="시공사"/>
					</td>
				</tr>
				<tr>
					<td>현장위치</td>
