...
<div class="right_content">
	...
	<div class="table01_content">
		...
		<div style="font-size : 22px;" id="workSummary" name="workSummary">
			...
			&nbsp;&nbsp;&nbsp;남은수량 ${totalWorkQuantity.quantityLeft} 본 
			&nbsp;&nbsp;&nbsp;총 작업수량 <input type="text" class="input01" id="quantity" name="quantity" value="${totalWorkQuantity.quantity}"style="width: 100px;">&nbsp;본
