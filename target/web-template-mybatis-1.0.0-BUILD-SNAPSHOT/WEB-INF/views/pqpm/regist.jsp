...
<script type="text/javascript">
	...
	function goBack(){
		location.href='${pageContext.request.contextPath}/pqpm/list?constructionIdx=${param.constructionIdx}'
	}
...
<div class="section-right">
	<p class="sub-tit text-center">파일수량 관리계획 파일 등록</p>

	<!--공지내용-->
	<div class="min640">
		<form:form method="POST" commandName="domain" enctype="multipart/form-data"  action="${pageContext.request.contextPath}/pqpm/regist2">
